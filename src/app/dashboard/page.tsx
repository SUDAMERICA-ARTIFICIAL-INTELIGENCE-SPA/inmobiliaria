...
export default function DashboardPage() {
    ...
    const handleMapSelect = useCallback((property: Property) => {
        ...
        return (
            <div className="h-screen flex items-center justify-center bg-dark-900 text-red-500">
                <div className="text-center space-y-4">
                    ...
                    <Button onClick={reloadData} variant="outline" className="border-red-500 text-red-500 hover:bg-red-500/10">
                        Reintentar Conexión
                    </Button>
                </div>
            </div>
